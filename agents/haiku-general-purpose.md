...
model: haiku
description: Fast, lightweight subagent for tasks requiring less analysis. Good for research, summarization, file operations, and quick tool calls. Use when speed and cost matter more than deep reasoning.
---
